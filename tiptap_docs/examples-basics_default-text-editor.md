...
source_url: https://tiptap.dev/docs/examples/basics/default-text-editor
og:image:height: 630
twitter:description: Learn how to create a super basic text editor in Tiptap with a short code example. More in our documentation!
description: Learn how to create a super basic text editor in Tiptap with a short code example. More in our documentation!
ogUrl: https://tiptap.dev/docs/examples/basics/default-text-editor
favicon: https://tiptap.dev/docs/favicon.png
og:title: Default text editor example | Tiptap Editor Docs
ogLocale: en_US
og:type: website
og:description: Learn how to create a super basic text editor in Tiptap with a short code example. More in our documentation!
og:locale: en_US
og:image: https://tiptap.dev/docs/api/og?title=Default%20text%20editor&category=Examples
twitter:card: summary_large_image
twitter:title: Default text editor example | Tiptap Editor Docs
ogDescription: Learn how to create a super basic text editor in Tiptap with a short code example. More in our documentation!
ogTitle: Default text editor example | Tiptap Editor Docs
docsearch:version: 2.x
robots: index, follow
og:url: https://tiptap.dev/docs/examples/basics/default-text-editor
twitter:image: https://tiptap.dev/docs/api/og?title=Default%20text%20editor&category=Examples
ogImage: https://tiptap.dev/docs/api/og?title=Default%20text%20editor&category=Examples
viewport: width=device-width, initial-scale=1
language: en
og:image:width: 1200
scrapeId: 4b01a054-3474-4838-9da6-1512bce383bb
sourceURL: https://tiptap.dev/docs/examples/basics/default-text-editor
url: https://tiptap.dev/docs/examples/basics/default-text-editor
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    
*   [Details](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    
*   [About](https://tiptap.dev/docs/examples/basics/default-text-editor#)
...
[Show details](https://tiptap.dev/docs/examples/basics/default-text-editor#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/examples/basics/default-text-editor#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/examples/basics/default-text-editor#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/examples/basics/default-text-editor#)
...
[Cross-domain consent2](https://tiptap.dev/docs/examples/basics/default-text-editor#)

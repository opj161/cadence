...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#page-title
og:url: https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule
ogDescription: Use the Horizontal Rule extension in Tiptap to render the `<hr>` HTML tag for separating content. Learn more in our docs!
ogImage: https://tiptap.dev/docs/api/og?title=HorizontalRule%20extension&category=Editor
twitter:title: HorizontalRule extension | Tiptap Editor Docs
favicon: https://tiptap.dev/docs/favicon.png
language: en
viewport: width=device-width, initial-scale=1
ogLocale: en_US
og:title: HorizontalRule extension | Tiptap Editor Docs
og:type: website
twitter:image: https://tiptap.dev/docs/api/og?title=HorizontalRule%20extension&category=Editor
og:description: Use the Horizontal Rule extension in Tiptap to render the `<hr>` HTML tag for separating content. Learn more in our docs!
ogTitle: HorizontalRule extension | Tiptap Editor Docs
og:locale: en_US
twitter:description: Use the Horizontal Rule extension in Tiptap to render the `<hr>` HTML tag for separating content. Learn more in our docs!
docsearch:version: 2.x
robots: index, follow
twitter:card: summary_large_image
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule
...
og:image:width: 1200
og:image: https://tiptap.dev/docs/api/og?title=HorizontalRule%20extension&category=Editor
og:image:height: 630
scrapeId: 35c96944-b9ba-4731-9363-3e5fdb006176
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#install)
Install
-----------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#settings)
Settings
-------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#commands)
Commands
-------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#sethorizontalrule)
setHorizontalRule()
...
[](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#source-code)
Source code
-------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#commands)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/horizontal-rule#source-code)

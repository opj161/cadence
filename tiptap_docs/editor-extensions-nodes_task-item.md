...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/task-item#page-title
og:image:width: 1200
og:description: Use the TaskItem extension to add support for task items rendered as <li data-type="taskItem"> with checkboxes. More in our docs!
twitter:image: https://tiptap.dev/docs/api/og?title=TaskItem%20extension&category=Editor
twitter:card: summary_large_image
robots: index, follow
viewport: width=device-width, initial-scale=1
og:url: https://tiptap.dev/docs/editor/extensions/nodes/task-item
favicon: https://tiptap.dev/docs/favicon.png
ogImage: https://tiptap.dev/docs/api/og?title=TaskItem%20extension&category=Editor
...
og:image: https://tiptap.dev/docs/api/og?title=TaskItem%20extension&category=Editor
og:image:height: 630
ogDescription: Use the TaskItem extension to add support for task items rendered as <li data-type="taskItem"> with checkboxes. More in our docs!
og:title: TaskItem extension | Tiptap Editor Docs
twitter:title: TaskItem extension | Tiptap Editor Docs
docsearch:version: 2.x
language: en
ogTitle: TaskItem extension | Tiptap Editor Docs
twitter:description: Use the TaskItem extension to add support for task items rendered as <li data-type="taskItem"> with checkboxes. More in our docs!
og:type: website
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/task-item
ogLocale: en_US
og:locale: en_US
scrapeId: 4b807665-1294-4cee-94e6-673ff3e9d956
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/task-item#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/task-item#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/task-item#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-item#install)
Install
-----------------------------------------------------------------------------
...
This extension requires the [`TaskList`](https://tiptap.dev/docs/editor/extensions/nodes/task-list)
 node.

[](https://tiptap.dev/docs/editor/extensions/nodes/task-item#settings)
Settings
-------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/task-item#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/task-item#nested)
nested
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/task-item#onreadonlychecked)
onReadOnlyChecked
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-item#keyboard-shortcuts)
Keyboard shortcuts
---------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-item#source-code)
Source code
-------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/task-item#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/task-item#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/task-item#settings)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/task-item#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/task-item#source-code)

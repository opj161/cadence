...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#page-title
og:image:height: 630
og:description: Use the Ordered List extension in Tiptap to enable ordered lists rendered as <ol> HTML tags. Learn more in our docs!
twitter:title: OrderedList extension | Tiptap Editor Docs
ogTitle: OrderedList extension | Tiptap Editor Docs
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/ordered-list
og:image: https://tiptap.dev/docs/api/og?title=OrderedList%20extension&category=Editor
twitter:description: Use the Ordered List extension in Tiptap to enable ordered lists rendered as <ol> HTML tags. Learn more in our docs!
og:url: https://tiptap.dev/docs/editor/extensions/nodes/ordered-list
...
og:image:width: 1200
ogDescription: Use the Ordered List extension in Tiptap to enable ordered lists rendered as <ol> HTML tags. Learn more in our docs!
language: en
robots: index, follow
og:type: website
ogImage: https://tiptap.dev/docs/api/og?title=OrderedList%20extension&category=Editor
og:title: OrderedList extension | Tiptap Editor Docs
og:locale: en_US
ogLocale: en_US
twitter:card: summary_large_image
favicon: https://tiptap.dev/docs/favicon.png
twitter:image: https://tiptap.dev/docs/api/og?title=OrderedList%20extension&category=Editor
docsearch:version: 2.x
viewport: width=device-width, initial-scale=1
scrapeId: 42d48173-fb3e-4fa2-8e65-6e5a0615a16d
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#)
...
If you want to modify the standard behavior of backspace and delete functions for lists, you should read about the [ListKeymap](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap)
 extension.
...
This extension requires the [`ListItem`](https://tiptap.dev/docs/editor/extensions/nodes/list-item)
 node.

[](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#settings)
Settings
----------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#itemtypename)
itemTypeName
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#keepmarks)
keepMarks
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#keepattributes)
keepAttributes
...
[](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#commands)
Commands
----------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#toggleorderedlist)
toggleOrderedList()
...
[](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#keyboard-shortcuts)
Keyboard shortcuts
------------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#source-code)
Source code
----------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list#source-code)

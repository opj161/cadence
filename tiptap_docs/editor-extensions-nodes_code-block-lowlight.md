...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#page-title
twitter:card: summary_large_image
og:image: https://tiptap.dev/docs/api/og?title=CodeBlockLowlight%20extension&category=Editor
ogTitle: CodeBlockLowlight extension | Tiptap Editor Docs
og:image:width: 1200
og:url: https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight
language: en
ogLocale: en_US
ogImage: https://tiptap.dev/docs/api/og?title=CodeBlockLowlight%20extension&category=Editor
og:title: CodeBlockLowlight extension | Tiptap Editor Docs
robots: index, follow
twitter:title: CodeBlockLowlight extension | Tiptap Editor Docs
...
twitter:image: https://tiptap.dev/docs/api/og?title=CodeBlockLowlight%20extension&category=Editor
docsearch:version: 2.x
viewport: width=device-width, initial-scale=1
twitter:description: Use the CodeBlockLowlight extension to add code blocks with syntax highlighting to your documents. Learn more in our docs!
ogDescription: Use the CodeBlockLowlight extension to add code blocks with syntax highlighting to your documents. Learn more in our docs!
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight
og:image:height: 630
og:type: website
og:description: Use the CodeBlockLowlight extension to add code blocks with syntax highlighting to your documents. Learn more in our docs!
og:locale: en_US
scrapeId: de378e78-17cf-4887-a58f-a4f7197fd546
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#)
...
This extension relies on the [lowlight](https://github.com/wooorm/lowlight)
 library to apply syntax highlight to the code block’s content.
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#install)
Install
---------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#settings)
Settings
-----------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#lowlight)
lowlight
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#languageclassprefix)
languageClassPrefix
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#defaultlanguage)
defaultLanguage
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#commands)
Commands
-----------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#setcodeblock)
setCodeBlock()
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#togglecodeblock)
toggleCodeBlock()
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#keyboard-shortcuts)
Keyboard shortcuts
-------------------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#source-code)
Source code
-----------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight#source-code)

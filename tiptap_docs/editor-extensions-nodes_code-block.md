...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/code-block#page-title
twitter:description: Use the CodeBlock extension in Tiptap to add fenced code blocks to your documents. Learn more in our docs!
ogDescription: Use the CodeBlock extension in Tiptap to add fenced code blocks to your documents. Learn more in our docs!
ogTitle: CodeBlock extension | Tiptap Editor Docs
twitter:card: summary_large_image
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/code-block
og:url: https://tiptap.dev/docs/editor/extensions/nodes/code-block
twitter:image: https://tiptap.dev/docs/api/og?title=CodeBlock%20extension&category=Editor
twitter:title: CodeBlock extension | Tiptap Editor Docs
og:locale: en_US
og:image:width: 1200
ogImage: https://tiptap.dev/docs/api/og?title=CodeBlock%20extension&category=Editor
robots: index, follow
language: en
og:image: https://tiptap.dev/docs/api/og?title=CodeBlock%20extension&category=Editor
description: Use the CodeBlock extension in Tiptap to add fenced code blocks to your documents. Learn more in our docs!
og:title: CodeBlock extension | Tiptap Editor Docs
og:image:height: 630
og:description: Use the CodeBlock extension in Tiptap to add fenced code blocks to your documents. Learn more in our docs!
og:type: website
favicon: https://tiptap.dev/docs/favicon.png
viewport: width=device-width, initial-scale=1
ogLocale: en_US
docsearch:version: 2.x
scrapeId: 840bd4f3-c047-47f9-86b4-775c5eae9f94
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/code-block#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/code-block#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/code-block#)
...
The CodeBlock extension doesn’t come with styling and has no syntax highlighting built-in. Try the [CodeBlockLowlight](https://tiptap.dev/docs/editor/extensions/nodes/code-block-lowlight)
 extension if you’re looking for code blocks with syntax highlighting.

[](https://tiptap.dev/docs/editor/extensions/nodes/code-block#install)
Install
------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block#settings)
Settings
--------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#languageclassprefix)
languageClassPrefix
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#exitontripleenter)
exitOnTripleEnter
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#defaultlanguage)
defaultLanguage
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#exitonarrowdown)
exitOnArrowDown
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block#commands)
Commands
--------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#setcodeblock)
setCodeBlock()
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/code-block#togglecodeblock)
toggleCodeBlock()
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block#keyboard-shortcuts)
Keyboard shortcuts
----------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/code-block#source-code)
Source code
--------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/code-block#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/code-block#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/code-block#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/code-block#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/code-block#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/code-block#source-code)

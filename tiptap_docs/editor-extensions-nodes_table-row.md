...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/table-row#page-title
ogTitle: TableRow extension | Tiptap Editor Docs
twitter:card: summary_large_image
twitter:description: Use the Table Row extension in Tiptap to add rows to your tables for a better table structure. Learn more in our docs!
...
og:url: https://tiptap.dev/docs/editor/extensions/nodes/table-row
og:type: website
robots: index, follow
ogDescription: Use the Table Row extension in Tiptap to add rows to your tables for a better table structure. Learn more in our docs!
ogLocale: en_US
viewport: width=device-width, initial-scale=1
og:image:width: 1200
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/table-row
og:image:height: 630
twitter:title: TableRow extension | Tiptap Editor Docs
ogImage: https://tiptap.dev/docs/api/og?title=TableRow%20extension&category=Editor
og:image: https://tiptap.dev/docs/api/og?title=TableRow%20extension&category=Editor
og:description: Use the Table Row extension in Tiptap to add rows to your tables for a better table structure. Learn more in our docs!
og:title: TableRow extension | Tiptap Editor Docs
language: en
favicon: https://tiptap.dev/docs/favicon.png
twitter:image: https://tiptap.dev/docs/api/og?title=TableRow%20extension&category=Editor
og:locale: en_US
docsearch:version: 2.x
scrapeId: bcb02081-3efc-40d7-97d7-d9ccb53ebfc4
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/table-row#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/table-row#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/table-row#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/table-row#install)
Install
-----------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/table-row#source-code)
Source code
-------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/table-row#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/table-row#install)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/table-row#source-code)

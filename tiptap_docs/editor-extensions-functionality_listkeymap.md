...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#page-title
ogDescription: Add extra keymap handlers to change the default backspace and delete behavior for lists. Learn more in our docs!
og:description: Add extra keymap handlers to change the default backspace and delete behavior for lists. Learn more in our docs!
twitter:card: summary_large_image
favicon: https://tiptap.dev/docs/favicon.png
og:image:width: 1200
twitter:description: Add extra keymap handlers to change the default backspace and delete behavior for lists. Learn more in our docs!
og:image:height: 630
twitter:image: https://tiptap.dev/docs/api/og?title=List%20Keymap%20extension&category=Editor
docsearch:version: 2.x
robots: index, follow
og:locale: en_US
ogImage: https://tiptap.dev/docs/api/og?title=List%20Keymap%20extension&category=Editor
og:url: https://tiptap.dev/docs/editor/extensions/functionality/listkeymap
twitter:title: List Keymap extension | Tiptap Editor Docs
...
og:type: website
ogLocale: en_US
og:image: https://tiptap.dev/docs/api/og?title=List%20Keymap%20extension&category=Editor
og:title: List Keymap extension | Tiptap Editor Docs
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/listkeymap
language: en
ogTitle: List Keymap extension | Tiptap Editor Docs
scrapeId: b2cd2445-b552-4b08-9b5c-60d77cb02f8e
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#)
...
[](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#install)
Install
--------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#settings)
Settings
----------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#listtypes)
listTypes
...
[](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#source-code)
Source code
----------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#settings)
 [Source code](https://tiptap.dev/docs/editor/extensions/functionality/listkeymap#source-code)

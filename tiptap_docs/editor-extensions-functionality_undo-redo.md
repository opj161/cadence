...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#page-title
language: en
ogImage: https://tiptap.dev/docs/api/og?title=Undo%2FRedo%20extension&category=Editor
...
ogTitle: Undo/Redo extension | Tiptap Editor Docs
og:title: Undo/Redo extension | Tiptap Editor Docs
og:locale: en_US
ogDescription: Undo and redo changes in your Tiptap Editor with ease, allowing you to revert or reapply edits in your editor. More in the docs.
favicon: https://tiptap.dev/docs/favicon.png
robots: index, follow
og:type: website
twitter:card: summary_large_image
ogLocale: en_US
og:description: Undo and redo changes in your Tiptap Editor with ease, allowing you to revert or reapply edits in your editor. More in the docs.
twitter:title: Undo/Redo extension | Tiptap Editor Docs
twitter:description: Undo and redo changes in your Tiptap Editor with ease, allowing you to revert or reapply edits in your editor. More in the docs.
og:image:height: 630
viewport: width=device-width, initial-scale=1
og:image: https://tiptap.dev/docs/api/og?title=Undo%2FRedo%20extension&category=Editor
og:url: https://tiptap.dev/docs/editor/extensions/functionality/undo-redo
og:image:width: 1200
twitter:image: https://tiptap.dev/docs/api/og?title=Undo%2FRedo%20extension&category=Editor
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/undo-redo
docsearch:version: 2.x
scrapeId: 303afd7a-1eb6-46d5-9091-a74e3605f873
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#)
...
[](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#install)
Install
-------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#settings)
Settings
---------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#depth)
depth
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#newgroupdelay)
newGroupDelay
...
[](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#commands)
Commands
---------------------------------------------------------------------------------------
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#redo)
redo()
...
[](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#keyboard-shortcuts)
Keyboard shortcuts
-----------------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#source-code)
Source code
---------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/functionality/undo-redo#source-code)

...
source_url: https://tiptap.dev/docs/comments/getting-started/install#page-title
viewport: width=device-width, initial-scale=1
language: en
og:locale: en_US
docsearch:version: 2.x
og:description: Install the comments extension in Tiptap to add threaded discussions to your editor and app. Learn more in the docs!
ogTitle: Install comments | Tiptap Comments Docs
og:url: https://tiptap.dev/docs/comments/getting-started/install
twitter:title: Install comments | Tiptap Comments Docs
twitter:image: https://tiptap.dev/docs/api/og?title=Install%20the%20Comments%20extension&category=Comments
ogImage: https://tiptap.dev/docs/api/og?title=Install%20the%20Comments%20extension&category=Comments
og:image: https://tiptap.dev/docs/api/og?title=Install%20the%20Comments%20extension&category=Comments
...
ogLocale: en_US
ogDescription: Install the comments extension in Tiptap to add threaded discussions to your editor and app. Learn more in the docs!
og:title: Install comments | Tiptap Comments Docs
og:image:width: 1200
og:type: website
favicon: https://tiptap.dev/docs/favicon.png
og:image:height: 630
twitter:card: summary_large_image
ogUrl: https://tiptap.dev/docs/comments/getting-started/install
twitter:description: Install the comments extension in Tiptap to add threaded discussions to your editor and app. Learn more in the docs!
robots: index, follow
scrapeId: e9da6c5c-1bda-4f5d-94b6-b8e22484905e
sourceURL: https://tiptap.dev/docs/comments/getting-started/install#page-title
url: https://tiptap.dev/docs/comments/getting-started/install#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/comments/getting-started/install#)
    
*   [Details](https://tiptap.dev/docs/comments/getting-started/install#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/comments/getting-started/install#)
    
*   [About](https://tiptap.dev/docs/comments/getting-started/install#)
...
[Show details](https://tiptap.dev/docs/comments/getting-started/install#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/comments/getting-started/install#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/comments/getting-started/install#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/comments/getting-started/install#)
...
[Cross-domain consent2](https://tiptap.dev/docs/comments/getting-started/install#)
...
This extension requires a valid subscription and a running [Tiptap Cloud instance](https://cloud.tiptap.dev/)
...
[Introduction](https://tiptap.dev/docs/comments/getting-started/install#page-title)
[Integrating the Comments extension](https://tiptap.dev/docs/comments/getting-started/install#integrating-the-comments-extension)

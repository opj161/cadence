...
source_url: https://tiptap.dev/docs/content-ai/capabilities/generation/overview#page-title
twitter:description: Integrate AI features into your editor like smart autocompletion, image generation and more. Read about it in our docs.
docsearch:version: 2.x
og:type: website
favicon: https://tiptap.dev/docs/favicon.png
twitter:card: summary_large_image
og:url: https://tiptap.dev/docs/content-ai/capabilities/generation/overview
language: en
...
og:description: Integrate AI features into your editor like smart autocompletion, image generation and more. Read about it in our docs.
ogTitle: AI Generation | Tiptap Content AI
ogImage: https://tiptap.dev/docs/api/og?title=Integrate%20AI%20into%20your%20editor&category=Content%20AI
ogDescription: Integrate AI features into your editor like smart autocompletion, image generation and more. Read about it in our docs.
og:locale: en_US
og:image: https://tiptap.dev/docs/api/og?title=Integrate%20AI%20into%20your%20editor&category=Content%20AI
og:image:width: 1200
robots: index, follow
og:image:height: 630
twitter:title: AI Generation | Tiptap Content AI
ogLocale: en_US
og:title: AI Generation | Tiptap Content AI
twitter:image: https://tiptap.dev/docs/api/og?title=Integrate%20AI%20into%20your%20editor&category=Content%20AI
ogUrl: https://tiptap.dev/docs/content-ai/capabilities/generation/overview
scrapeId: efcf63c1-0104-4af3-8980-2254d60fa4df
sourceURL: https://tiptap.dev/docs/content-ai/capabilities/generation/overview#page-title
url: https://tiptap.dev/docs/content-ai/capabilities/generation/overview#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    
*   [Details](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    
*   [About](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
...
[Show details](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
...
[Cross-domain consent2](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#)
...
This extension requires a valid subscription. To install the extension, you need [access to our private registry](https://tiptap.dev/docs/guides/pro-extensions)
.

[](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#ai-generation-features)
AI Generation features
---------------------------------------------------------------------------------------------------------------------

*   [Pre-configured default commands](https://tiptap.dev/docs/content-ai/capabilities/generation/text-generation)
    
*   [Autocompletion for efficient editing](https://tiptap.dev/docs/content-ai/capabilities/generation/text-generation/autocompletion)
    
*   Real-time streaming for commands
*   Compatibility with various OpenAI models (e.g., gpt-3.5-turbo, gpt-4, gpt-4o, dall-e-3)
*   [Create your own prompts and commands](https://tiptap.dev/docs/content-ai/capabilities/generation/text-generation/custom-commands)
    
*   [Custom LLM integration for business accounts](https://tiptap.dev/docs/content-ai/capabilities/generation/custom-llms)
    

[](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#how-it-works)
How it works
-------------------------------------------------------------------------------------------------

Integrate [OpenAI](https://tiptap.dev/docs/content-ai/capabilities/generation/install)
 or your own [Custom LLM](https://tiptap.dev/docs/content-ai/capabilities/generation/custom-llms)
 with your Tiptap Editor. The extension covers both, the client and server-side implementations. Here’s the user experience:
...
[Introduction](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#page-title)
[AI Generation features](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#ai-generation-features)
 [How it works](https://tiptap.dev/docs/content-ai/capabilities/generation/overview#how-it-works)

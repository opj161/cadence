...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/textalign#page-title
ogImage: https://tiptap.dev/docs/api/og?title=TextAlign%20extension&category=Editor
viewport: width=device-width, initial-scale=1
og:image: https://tiptap.dev/docs/api/og?title=TextAlign%20extension&category=Editor
og:image:height: 630
language: en
twitter:card: summary_large_image
robots: index, follow
og:image:width: 1200
twitter:title: TextAlign extension | Tiptap Editor Docs
ogLocale: en_US
og:type: website
ogTitle: TextAlign extension | Tiptap Editor Docs
docsearch:version: 2.x
og:description: Left, right, center, whatever! Align the text however you like with the Text Align extension. More in the docs!
og:locale: en_US
twitter:description: Left, right, center, whatever! Align the text however you like with the Text Align extension. More in the docs!
og:title: TextAlign extension | Tiptap Editor Docs
twitter:image: https://tiptap.dev/docs/api/og?title=TextAlign%20extension&category=Editor
...
og:url: https://tiptap.dev/docs/editor/extensions/functionality/textalign
ogDescription: Left, right, center, whatever! Align the text however you like with the Text Align extension. More in the docs!
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/textalign
scrapeId: 0352708e-73e2-4e5b-9aaa-b7b9e9de3513
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/textalign#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/textalign#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/textalign#)
...
[](https://tiptap.dev/docs/editor/extensions/functionality/textalign#install)
Install
-------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/textalign#settings)
Settings
---------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/textalign#types)
types
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/textalign#alignments)
alignments
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/textalign#defaultalignment)
defaultAlignment
...
[](https://tiptap.dev/docs/editor/extensions/functionality/textalign#commands)
Commands
---------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/textalign#settextalign)
setTextAlign()
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/textalign#unsettextalign)
unsetTextAlign()
...
[](https://tiptap.dev/docs/editor/extensions/functionality/textalign#keyboard-shortcuts)
Keyboard shortcuts
-----------------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/textalign#source-code)
Source code
---------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/textalign#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/textalign#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/functionality/textalign#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/functionality/textalign#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/functionality/textalign#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/functionality/textalign#source-code)

...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/list-item#page-title
ogDescription: Use the List Item extension in Tiptap to add support for the `<li>` tag used in bullet and ordered lists. Learn more in our docs!
ogLocale: en_US
favicon: https://tiptap.dev/docs/favicon.png
language: en
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/list-item
og:title: ListItem Extension | Tiptap Editor Docs
ogTitle: ListItem Extension | Tiptap Editor Docs
og:url: https://tiptap.dev/docs/editor/extensions/nodes/list-item
docsearch:version: 2.x
og:locale: en_US
twitter:title: ListItem Extension | Tiptap Editor Docs
twitter:description: Use the List Item extension in Tiptap to add support for the `<li>` tag used in bullet and ordered lists. Learn more in our docs!
og:image:width: 1200
robots: index, follow
og:image: https://tiptap.dev/docs/api/og?title=ListItem%20extension&category=Editor
viewport: width=device-width, initial-scale=1
og:description: Use the List Item extension in Tiptap to add support for the `<li>` tag used in bullet and ordered lists. Learn more in our docs!
og:image:height: 630
ogImage: https://tiptap.dev/docs/api/og?title=ListItem%20extension&category=Editor
twitter:card: summary_large_image
twitter:image: https://tiptap.dev/docs/api/og?title=ListItem%20extension&category=Editor
og:type: website
...
scrapeId: 238b3051-b2d1-4a71-98ca-3d3c2e7ad9e3
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/list-item#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/list-item#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/list-item#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/list-item#install)
Install
-----------------------------------------------------------------------------
...
This extension requires the [`BulletList`](https://tiptap.dev/docs/editor/extensions/nodes/bullet-list)
 or [`OrderedList`](https://tiptap.dev/docs/editor/extensions/nodes/ordered-list)
 node.

[](https://tiptap.dev/docs/editor/extensions/nodes/list-item#settings)
Settings
-------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/list-item#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/nodes/list-item#keyboard-shortcuts)
Keyboard shortcuts
---------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/list-item#source-code)
Source code
-------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/list-item#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/list-item#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/list-item#settings)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/list-item#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/list-item#source-code)

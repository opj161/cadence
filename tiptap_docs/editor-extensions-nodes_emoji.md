...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/emoji#page-title
ogLocale: en_US
ogDescription: Use the Emoji extension in Tiptap to render emojis as inline nodes with fallback images for unsupported emojis.
language: en
og:image: https://tiptap.dev/docs/api/og?title=Emoji%20extension&category=Editor
twitter:card: summary_large_image
twitter:image: https://tiptap.dev/docs/api/og?title=Emoji%20extension&category=Editor
twitter:title: Emoji extension | Tiptap Editor Docs
og:url: https://tiptap.dev/docs/editor/extensions/nodes/emoji
twitter:description: Use the Emoji extension in Tiptap to render emojis as inline nodes with fallback images for unsupported emojis.
og:image:width: 1200
docsearch:version: 2.x
og:description: Use the Emoji extension in Tiptap to render emojis as inline nodes with fallback images for unsupported emojis.
viewport: width=device-width, initial-scale=1
og:type: website
favicon: https://tiptap.dev/docs/favicon.png
ogTitle: Emoji extension | Tiptap Editor Docs
...
og:image:height: 630
og:locale: en_US
og:title: Emoji extension | Tiptap Editor Docs
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/emoji
robots: index, follow
ogImage: https://tiptap.dev/docs/api/og?title=Emoji%20extension&category=Editor
scrapeId: 8f417657-b6fe-4951-991e-ccfca0ff978f
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/emoji#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/emoji#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/emoji#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/emoji#install)
Install
-------------------------------------------------------------------------

### Set up access to Tiptap's private repository

Integrate this pro extension by registering for a free [Tiptap account](https://cloud.tiptap.dev/register)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/emoji#dependencies)
Dependencies
-----------------------------------------------------------------------------------

To place the popups correctly, we’re using [tippy.js](https://atomiks.github.io/tippyjs/)
 in all our examples. You are free to bring your own library, but if you’re fine with it, just install what we use:

    npm install tippy.js
    

[](https://tiptap.dev/docs/editor/extensions/nodes/emoji#settings)
Settings
---------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#emojis)
emojis
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#enableemoticons)
enableEmoticons
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#forcefallbackimages)
forceFallbackImages
...
#### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#add-custom-emojis)
Add custom emojis
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/emoji#suggestion)
suggestion

[Read more](https://tiptap.dev/docs/editor/api/utilities/suggestion)
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/emoji#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/emoji#install)
 [Dependencies](https://tiptap.dev/docs/editor/extensions/nodes/emoji#dependencies)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/emoji#settings)

...
source_url: https://tiptap.dev/docs/editor/extensions/marks/highlight#page-title
ogUrl: https://tiptap.dev/docs/editor/extensions/marks/highlight
og:url: https://tiptap.dev/docs/editor/extensions/marks/highlight
robots: index, follow
description: Use the Highlight extension in your Tiptap Editor to add colorful text highlights. Learn more in our docs!
twitter:description: Use the Highlight extension in your Tiptap Editor to add colorful text highlights. Learn more in our docs!
favicon: https://tiptap.dev/docs/favicon.png
ogTitle: Highlight extension | Tiptap Editor Docs
ogDescription: Use the Highlight extension in your Tiptap Editor to add colorful text highlights. Learn more in our docs!
og:image: https://tiptap.dev/docs/api/og?title=Highlight%20extension&category=Editor
twitter:title: Highlight extension | Tiptap Editor Docs
language: en
ogLocale: en_US
og:description: Use the Highlight extension in your Tiptap Editor to add colorful text highlights. Learn more in our docs!
ogImage: https://tiptap.dev/docs/api/og?title=Highlight%20extension&category=Editor
og:title: Highlight extension | Tiptap Editor Docs
og:image:width: 1200
viewport: width=device-width, initial-scale=1
og:image:height: 630
og:locale: en_US
og:type: website
twitter:image: https://tiptap.dev/docs/api/og?title=Highlight%20extension&category=Editor
docsearch:version: 2.x
twitter:card: summary_large_image
scrapeId: d00b9a9f-458f-452f-a2dd-0d74de429368
sourceURL: https://tiptap.dev/docs/editor/extensions/marks/highlight#page-title
url: https://tiptap.dev/docs/editor/extensions/marks/highlight#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/marks/highlight#)
...
[](https://tiptap.dev/docs/editor/extensions/marks/highlight#install)
Install
-----------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/highlight#settings)
Settings
-------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/highlight#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/marks/highlight#multicolor)
multicolor
...
[](https://tiptap.dev/docs/editor/extensions/marks/highlight#commands)
Commands
-------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/highlight#sethighlight)
setHighlight()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/highlight#togglehighlight)
toggleHighlight()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/highlight#unsethighlight)
unsetHighlight()
...
[](https://tiptap.dev/docs/editor/extensions/marks/highlight#keyboard-shortcuts)
Keyboard shortcuts
---------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/highlight#source-code)
Source code
-------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/marks/highlight#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/marks/highlight#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/marks/highlight#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/marks/highlight#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/marks/highlight#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/marks/highlight#source-code)

...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/hard-break#page-title
ogDescription: Use the Hard Break extension in Tiptap to add support for the <br> HTML tag for line breaks. Learn more in our docs!
og:image: https://tiptap.dev/docs/api/og?title=HardBreak%20extension&category=Editor
twitter:description: Use the Hard Break extension in Tiptap to add support for the <br> HTML tag for line breaks. Learn more in our docs!
og:url: https://tiptap.dev/docs/editor/extensions/nodes/hard-break
docsearch:version: 2.x
og:description: Use the Hard Break extension in Tiptap to add support for the <br> HTML tag for line breaks. Learn more in our docs!
og:locale: en_US
og:image:width: 1200
og:image:height: 630
ogTitle: HardBreak extension | Tiptap Editor Docs
...
ogImage: https://tiptap.dev/docs/api/og?title=HardBreak%20extension&category=Editor
robots: index, follow
language: en
favicon: https://tiptap.dev/docs/favicon.png
twitter:title: HardBreak extension | Tiptap Editor Docs
twitter:image: https://tiptap.dev/docs/api/og?title=HardBreak%20extension&category=Editor
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/hard-break
og:title: HardBreak extension | Tiptap Editor Docs
viewport: width=device-width, initial-scale=1
scrapeId: b5e88422-9623-4a83-9644-6b4d9d32e58c
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/hard-break#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/hard-break#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#install)
Install
------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#settings)
Settings
--------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#commands)
Commands
--------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#sethardbreak)
setHardBreak()
...
[](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#keyboard-shortcuts)
Keyboard shortcuts
----------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#source-code)
Source code
--------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/hard-break#source-code)

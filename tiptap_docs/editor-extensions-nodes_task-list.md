...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/task-list#page-title
ogImage: https://tiptap.dev/docs/api/og?title=TaskList%20extension&category=Editor
og:url: https://tiptap.dev/docs/editor/extensions/nodes/task-list
og:locale: en_US
og:image:width: 1200
og:type: website
twitter:card: summary_large_image
twitter:title: TaskList extension | Tiptap Editor Docs
twitter:image: https://tiptap.dev/docs/api/og?title=TaskList%20extension&category=Editor
...
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/task-list
language: en
og:image:height: 630
ogDescription: Use the Task List extension in Tiptap to add support for task lists rendered as <ul data-type="taskList">. More in our docs!
docsearch:version: 2.x
ogTitle: TaskList extension | Tiptap Editor Docs
og:description: Use the Task List extension in Tiptap to add support for task lists rendered as <ul data-type="taskList">. More in our docs!
og:title: TaskList extension | Tiptap Editor Docs
twitter:description: Use the Task List extension in Tiptap to add support for task lists rendered as <ul data-type="taskList">. More in our docs!
robots: index, follow
og:image: https://tiptap.dev/docs/api/og?title=TaskList%20extension&category=Editor
ogLocale: en_US
scrapeId: fea64ef0-4c78-40bd-b3a3-ca7a81159e27
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/task-list#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/task-list#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/task-list#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#install)
Install
-----------------------------------------------------------------------------
...
This extension requires the [`TaskItem`](https://tiptap.dev/docs/editor/extensions/nodes/task-item)
 extension.

[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#settings)
Settings
-------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/nodes/task-list#htmlattributes)
HTMLAttributes
...
### [](https://tiptap.dev/docs/editor/extensions/nodes/task-list#itemtypename)
itemTypeName
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#commands)
Commands
-------------------------------------------------------------------------------

[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#toggletasklist)
toggleTaskList()
=============================================================================================
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#keyboard-shortcuts)
Keyboard shortcuts
---------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/task-list#source-code)
Source code
-------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/task-list#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/task-list#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/nodes/task-list#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/nodes/task-list#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/nodes/task-list#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/task-list#source-code)

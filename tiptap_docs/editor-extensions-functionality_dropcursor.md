...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#page-title
viewport: width=device-width, initial-scale=1
og:locale: en_US
og:image:height: 630
ogTitle: Dropcursor extension | Tiptap Editor Docs
language: en
ogDescription: Add a cursor when dragging items inside the editor with the Dropcursor extension. Learn how to use it here in the Docs!
...
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/dropcursor
robots: index, follow
og:title: Dropcursor extension | Tiptap Editor Docs
og:description: Add a cursor when dragging items inside the editor with the Dropcursor extension. Learn how to use it here in the Docs!
og:type: website
twitter:title: Dropcursor extension | Tiptap Editor Docs
ogLocale: en_US
twitter:description: Add a cursor when dragging items inside the editor with the Dropcursor extension. Learn how to use it here in the Docs!
twitter:card: summary_large_image
twitter:image: https://tiptap.dev/docs/api/og?title=Dropcursor%20extension&category=Editor
docsearch:version: 2.x
ogImage: https://tiptap.dev/docs/api/og?title=Dropcursor%20extension&category=Editor
og:image:width: 1200
favicon: https://tiptap.dev/docs/favicon.png
og:image: https://tiptap.dev/docs/api/og?title=Dropcursor%20extension&category=Editor
og:url: https://tiptap.dev/docs/editor/extensions/functionality/dropcursor
scrapeId: bc551166-ca21-4ec5-9d27-661e77dc428d
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#)
...
This extension loads the [ProseMirror Dropcursor plugin](https://github.com/ProseMirror/prosemirror-dropcursor)
 by Marijn Haverbeke, which shows a cursor at the drop position when something is dragged into the editor.
...
[](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#install)
Install
--------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#settings)
Settings
----------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#color)
color
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#width)
width
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#class)
class
...
[](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#source-code)
Source code
----------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#settings)
 [Source code](https://tiptap.dev/docs/editor/extensions/functionality/dropcursor#source-code)

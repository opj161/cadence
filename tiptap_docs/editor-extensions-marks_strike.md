...
source_url: https://tiptap.dev/docs/editor/extensions/marks/strike#page-title
favicon: https://tiptap.dev/docs/favicon.png
og:image: https://tiptap.dev/docs/api/og?title=Strike%20extension&category=Editor
ogTitle: Strike extension | Tiptap Editor Docs
ogLocale: en_US
og:image:height: 630
og:image:width: 1200
robots: index, follow
og:description: Learn how to use the Strike extension in Tiptap to cut through the words you wrote if you're too afraid to delete it.
og:url: https://tiptap.dev/docs/editor/extensions/marks/strike
og:type: website
twitter:title: Strike extension | Tiptap Editor Docs
ogImage: https://tiptap.dev/docs/api/og?title=Strike%20extension&category=Editor
viewport: width=device-width, initial-scale=1
twitter:image: https://tiptap.dev/docs/api/og?title=Strike%20extension&category=Editor
docsearch:version: 2.x
ogDescription: Learn how to use the Strike extension in Tiptap to cut through the words you wrote if you're too afraid to delete it.
og:title: Strike extension | Tiptap Editor Docs
ogUrl: https://tiptap.dev/docs/editor/extensions/marks/strike
og:locale: en_US
twitter:description: Learn how to use the Strike extension in Tiptap to cut through the words you wrote if you're too afraid to delete it.
...
language: en
scrapeId: 3ed4b2b8-fe34-4622-be6b-b775c4b69aad
sourceURL: https://tiptap.dev/docs/editor/extensions/marks/strike#page-title
url: https://tiptap.dev/docs/editor/extensions/marks/strike#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/marks/strike#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/marks/strike#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/marks/strike#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/marks/strike#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/marks/strike#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/marks/strike#)
...
[](https://tiptap.dev/docs/editor/extensions/marks/strike#install)
Install
--------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/strike#settings)
Settings
----------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/strike#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/marks/strike#commands)
Commands
----------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/strike#setstrike)
setStrike()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/strike#togglestrike)
toggleStrike()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/strike#unsetstrike)
unsetStrike()
...
[](https://tiptap.dev/docs/editor/extensions/marks/strike#keyboard-shortcuts)
Keyboard shortcuts
------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/strike#source-code)
Source code
----------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/marks/strike#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/marks/strike#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/marks/strike#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/marks/strike#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/marks/strike#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/marks/strike#source-code)

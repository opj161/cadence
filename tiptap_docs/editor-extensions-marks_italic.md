...
source_url: https://tiptap.dev/docs/editor/extensions/marks/italic#page-title
og:image:width: 1200
docsearch:version: 2.x
ogImage: https://tiptap.dev/docs/api/og?title=Italic%20extension&category=Editor
og:title: Italic extension | Tiptap Editor Docs
og:description: Use the Italic extension in your Tiptap Editor to emphasize your text with italics. Learn more in our docs!
twitter:card: summary_large_image
og:type: website
robots: index, follow
viewport: width=device-width, initial-scale=1
favicon: https://tiptap.dev/docs/favicon.png
og:url: https://tiptap.dev/docs/editor/extensions/marks/italic
ogUrl: https://tiptap.dev/docs/editor/extensions/marks/italic
language: en
description: Use the Italic extension in your Tiptap Editor to emphasize your text with italics. Learn more in our docs!
og:image: https://tiptap.dev/docs/api/og?title=Italic%20extension&category=Editor
twitter:description: Use the Italic extension in your Tiptap Editor to emphasize your text with italics. Learn more in our docs!
ogDescription: Use the Italic extension in your Tiptap Editor to emphasize your text with italics. Learn more in our docs!
og:image:height: 630
twitter:image: https://tiptap.dev/docs/api/og?title=Italic%20extension&category=Editor
ogTitle: Italic extension | Tiptap Editor Docs
og:locale: en_US
twitter:title: Italic extension | Tiptap Editor Docs
ogLocale: en_US
scrapeId: 5f4e1d9c-503a-40de-97c7-13fa650163f9
sourceURL: https://tiptap.dev/docs/editor/extensions/marks/italic#page-title
url: https://tiptap.dev/docs/editor/extensions/marks/italic#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/marks/italic#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/marks/italic#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/marks/italic#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/marks/italic#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/marks/italic#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/marks/italic#)
...
[](https://tiptap.dev/docs/editor/extensions/marks/italic#install)
Install
--------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/italic#settings)
Settings
----------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/italic#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/marks/italic#commands)
Commands
----------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/italic#setitalic)
setItalic()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/italic#toggleitalic)
toggleItalic()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/italic#unsetitalic)
unsetItalic()
...
[](https://tiptap.dev/docs/editor/extensions/marks/italic#keyboard-shortcuts)
Keyboard shortcuts
------------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/italic#source-code)
Source code
----------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/marks/italic#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/marks/italic#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/marks/italic#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/marks/italic#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/marks/italic#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/marks/italic#source-code)

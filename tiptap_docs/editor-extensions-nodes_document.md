...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/document#page-title
og:locale: en_US
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/document
viewport: width=device-width, initial-scale=1
ogLocale: en_US
docsearch:version: 2.x
robots: index, follow
og:title: Document extension | Tiptap Editor Docs
og:url: https://tiptap.dev/docs/editor/extensions/nodes/document
ogImage: https://tiptap.dev/docs/api/og?title=Document%20extension&category=Editor
favicon: https://tiptap.dev/docs/favicon.png
ogDescription: Use the required Document extension as a home for all your editor’s nodes and content. Learn more in our docs!
og:description: Use the required Document extension as a home for all your editor’s nodes and content. Learn more in our docs!
og:image: https://tiptap.dev/docs/api/og?title=Document%20extension&category=Editor
og:image:height: 630
twitter:description: Use the required Document extension as a home for all your editor’s nodes and content. Learn more in our docs!
twitter:image: https://tiptap.dev/docs/api/og?title=Document%20extension&category=Editor
og:image:width: 1200
twitter:title: Document extension | Tiptap Editor Docs
ogTitle: Document extension | Tiptap Editor Docs
...
og:type: website
language: en
scrapeId: db0ce8c2-f036-4277-a96b-67c4f4f81450
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/document#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/document#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/document#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/document#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/document#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/document#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/document#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/document#)
...
Tiptap v1 tried to hide that node from you, but it has always been there. You have to explicitly import it from now on (or use [StarterKit](https://tiptap.dev/docs/editor/extensions/functionality/starterkit)
).

[](https://tiptap.dev/docs/editor/extensions/nodes/document#install)
Install
----------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/document#source-code)
Source code
------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/document#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/document#install)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/document#source-code)

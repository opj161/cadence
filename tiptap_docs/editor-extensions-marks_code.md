...
source_url: https://tiptap.dev/docs/editor/extensions/marks/code#page-title
ogUrl: https://tiptap.dev/docs/editor/extensions/marks/code
language: en
og:image:width: 1200
ogImage: https://tiptap.dev/docs/api/og?title=Code%20extension&category=Editor
docsearch:version: 2.x
ogDescription: Use the Code extension in your Tiptap Editor to add inline code to your texts. Learn more in our docs!
ogLocale: en_US
twitter:card: summary_large_image
viewport: width=device-width, initial-scale=1
og:title: Code extension | Tiptap Editor Docs
og:image:height: 630
og:type: website
ogTitle: Code extension | Tiptap Editor Docs
twitter:description: Use the Code extension in your Tiptap Editor to add inline code to your texts. Learn more in our docs!
og:url: https://tiptap.dev/docs/editor/extensions/marks/code
twitter:title: Code extension | Tiptap Editor Docs
favicon: https://tiptap.dev/docs/favicon.png
robots: index, follow
og:locale: en_US
description: Use the Code extension in your Tiptap Editor to add inline code to your texts. Learn more in our docs!
og:description: Use the Code extension in your Tiptap Editor to add inline code to your texts. Learn more in our docs!
twitter:image: https://tiptap.dev/docs/api/og?title=Code%20extension&category=Editor
og:image: https://tiptap.dev/docs/api/og?title=Code%20extension&category=Editor
scrapeId: 713ab111-84c8-4095-af8b-edd40690a59e
sourceURL: https://tiptap.dev/docs/editor/extensions/marks/code#page-title
url: https://tiptap.dev/docs/editor/extensions/marks/code#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/marks/code#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/marks/code#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/marks/code#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/marks/code#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/marks/code#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/marks/code#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/marks/code#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/marks/code#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/marks/code#)
...
[](https://tiptap.dev/docs/editor/extensions/marks/code#install)
Install
------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/code#settings)
Settings
--------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/code#htmlattributes)
HTMLAttributes
...
[](https://tiptap.dev/docs/editor/extensions/marks/code#commands)
Commands
--------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/marks/code#setcode)
setCode()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/code#togglecode)
toggleCode()
...
### [](https://tiptap.dev/docs/editor/extensions/marks/code#unsetcode)
unsetCode()
...
[](https://tiptap.dev/docs/editor/extensions/marks/code#keyboard-shortcuts)
Keyboard shortcuts
----------------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/marks/code#source-code)
Source code
--------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/marks/code#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/marks/code#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/marks/code#settings)
 [Commands](https://tiptap.dev/docs/editor/extensions/marks/code#commands)
 [Keyboard shortcuts](https://tiptap.dev/docs/editor/extensions/marks/code#keyboard-shortcuts)
 [Source code](https://tiptap.dev/docs/editor/extensions/marks/code#source-code)

...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#page-title
twitter:description: Prevent your cursor from getting stuck with the Gapcursor extension in Tiptap. Learn more in our documentation.
og:description: Prevent your cursor from getting stuck with the Gapcursor extension in Tiptap. Learn more in our documentation.
og:url: https://tiptap.dev/docs/editor/extensions/functionality/gapcursor
twitter:image: https://tiptap.dev/docs/api/og?title=Gapcursor%20extension&category=Editor
robots: index, follow
ogTitle: Gapcursor extension | Tiptap Editor Docs
ogImage: https://tiptap.dev/docs/api/og?title=Gapcursor%20extension&category=Editor
ogLocale: en_US
...
og:title: Gapcursor extension | Tiptap Editor Docs
ogDescription: Prevent your cursor from getting stuck with the Gapcursor extension in Tiptap. Learn more in our documentation.
og:image: https://tiptap.dev/docs/api/og?title=Gapcursor%20extension&category=Editor
favicon: https://tiptap.dev/docs/favicon.png
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/gapcursor
og:image:height: 630
og:locale: en_US
og:image:width: 1200
...
og:type: website
twitter:title: Gapcursor extension | Tiptap Editor Docs
scrapeId: 280d4a68-1710-4812-bcc1-5c342c0b86d5
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#)
...
This extension loads the [ProseMirror Gapcursor plugin](https://github.com/ProseMirror/prosemirror-gapcursor)
 by Marijn Haverbeke, which adds a gap for the cursor in places that don’t allow regular selection. For example, after a table at the end of a document.

Note that Tiptap is headless, but the gapcursor needs CSS for its appearance. The [default CSS](https://github.com/ueberdosis/tiptap/tree/main/packages/core/src/style.ts)
 is loaded through the Editor class.

[](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#install)
Install
-------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#source-code)
Source code
---------------------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#install)
 [Source code](https://tiptap.dev/docs/editor/extensions/functionality/gapcursor#source-code)

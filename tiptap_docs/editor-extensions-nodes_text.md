...
source_url: https://tiptap.dev/docs/editor/extensions/nodes/text#page-title
twitter:card: summary_large_image
twitter:title: Text extension | Tiptap Editor Docs
og:url: https://tiptap.dev/docs/editor/extensions/nodes/text
ogUrl: https://tiptap.dev/docs/editor/extensions/nodes/text
ogTitle: Text extension | Tiptap Editor Docs
og:image:height: 630
twitter:image: https://tiptap.dev/docs/api/og?title=Text%20extension&category=Editor
twitter:description: It's very likely that you want text in your text editor. Enable plain text support with the Text extension. More in the docs!
language: en
docsearch:version: 2.x
og:title: Text extension | Tiptap Editor Docs
og:description: It's very likely that you want text in your text editor. Enable plain text support with the Text extension. More in the docs!
og:image: https://tiptap.dev/docs/api/og?title=Text%20extension&category=Editor
og:type: website
viewport: width=device-width, initial-scale=1
ogImage: https://tiptap.dev/docs/api/og?title=Text%20extension&category=Editor
ogDescription: It's very likely that you want text in your text editor. Enable plain text support with the Text extension. More in the docs!
ogLocale: en_US
og:locale: en_US
...
og:image:width: 1200
scrapeId: 08584a4a-418c-42e1-a759-9ea30ec1cb81
sourceURL: https://tiptap.dev/docs/editor/extensions/nodes/text#page-title
url: https://tiptap.dev/docs/editor/extensions/nodes/text#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/nodes/text#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/nodes/text#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/nodes/text#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/nodes/text#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/nodes/text#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/nodes/text#)
...
[](https://tiptap.dev/docs/editor/extensions/nodes/text#install)
Install
------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/nodes/text#source-code)
Source code
--------------------------------------------------------------------------------
...
[Introduction](https://tiptap.dev/docs/editor/extensions/nodes/text#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/nodes/text#install)
 [Source code](https://tiptap.dev/docs/editor/extensions/nodes/text#source-code)

...
source_url: https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#page-title
ogUrl: https://tiptap.dev/docs/editor/extensions/functionality/uniqueid
description: Add a unique ID to every single node and keep track of them with the UniqueID extension. More in the docs!
og:image:height: 630
ogImage: https://tiptap.dev/docs/api/og?title=UniqueID%20extension&category=Editor
og:image:width: 1200
ogTitle: UniqueID extension | Tiptap Editor Docs
og:url: https://tiptap.dev/docs/editor/extensions/functionality/uniqueid
language: en
favicon: https://tiptap.dev/docs/favicon.png
ogLocale: en_US
og:type: website
og:locale: en_US
twitter:description: Add a unique ID to every single node and keep track of them with the UniqueID extension. More in the docs!
twitter:image: https://tiptap.dev/docs/api/og?title=UniqueID%20extension&category=Editor
twitter:title: UniqueID extension | Tiptap Editor Docs
og:title: UniqueID extension | Tiptap Editor Docs
twitter:card: summary_large_image
robots: index, follow
og:image: https://tiptap.dev/docs/api/og?title=UniqueID%20extension&category=Editor
docsearch:version: 2.x
ogDescription: Add a unique ID to every single node and keep track of them with the UniqueID extension. More in the docs!
viewport: width=device-width, initial-scale=1
og:description: Add a unique ID to every single node and keep track of them with the UniqueID extension. More in the docs!
scrapeId: 6edefe0a-bb63-4158-8e07-0a7643dcba55
sourceURL: https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#page-title
url: https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#page-title
statusCode: 200
---
...
*   [Consent](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    
*   [Details](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    
*   [\[#IABV2SETTINGS#\]](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    
*   [About](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
...
[Show details](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
...
*   Necessary 24
    ...
    *   [Cookiebot\
        \
        1](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [Google\
        \
        2](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [ai-demo.tiptap.dev  \
        ...
        \
        5](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [cdn.webflow.com  \
        hsforms.com  \
        \
        3](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [cloud.tiptap.dev  \
        tiptap.dev  \
        \
        4](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [hs-analytics.net  \
        hs-banner.com  \
        \
        6](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
...
*   Marketing 54
    ...
    *   [YouTube\
        \
        10](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
    ...
    *   [www.youtube-nocookie.com  \
        embed.tiptap.dev  \
        \
        22](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
...
[Cross-domain consent2](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#)
...
[](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#install)
Install
------------------------------------------------------------------------------------
...
[](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#settings)
Settings
--------------------------------------------------------------------------------------

### [](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#attributename)
attributeName
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#types)
types
...
### [](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#generateid)
generateID
...
[Introduction](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#page-title)
[Install](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#install)
 [Settings](https://tiptap.dev/docs/editor/extensions/functionality/uniqueid#settings)
